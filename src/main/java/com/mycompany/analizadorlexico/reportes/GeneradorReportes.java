...
public class GeneradorReportes {
    ...
    public void generarReporteErrores(List<ErrorLexico> listaErrores) {
        ...
        html.append("<h2>Reporte de Errores Lexicos - PromptZal</h2>\n");
    ...
    private void guardarArchivo(String ruta, String contenido) {
        try (FileWriter writer = new FileWriter(ruta)) {
            ...
            System.out.println("[ÉXITO] Se generó el archivo: " + ruta);
        } catch (IOException e) {
            System.out.println("[ERROR] No se pudo generar el archivo HTML: " + e.getMessage());
        }
    }
